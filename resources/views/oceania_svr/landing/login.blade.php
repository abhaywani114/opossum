@extends('oceania_svr.landing.web')
@section('subheader')
@endsection
@section('content')
	...
	<div class="modal-dialog modal-dialog-centered" role="document"
		...
		<div class="modal-content modal-inside bg-black"
			...
			@if (!empty($isLocationActive))
				background: url('{{asset('images/underwater_bubbling.gif')}}');
			...
			<div class="modal-body text-center"
				...
				@if (!empty($isLocationActive) && ($isServerEnd) )
                ...
                <div style="position:absolute;bottom:20px;right:20px"
                    ...
                    <div class="col-md-12 float-right" style="justify-content:flex-end;display:flex">
					@if (!empty($isLocationActive))
                        <button onclick="window.open('{{route("main.view.onehost")}}','_blank')"
