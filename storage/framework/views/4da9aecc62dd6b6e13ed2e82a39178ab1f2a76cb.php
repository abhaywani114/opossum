...
<body>
        ...
        <table border="0" style="width:100%; border-collapse: collapse"
            ...
            <tr>
                <td valign="bottom" colspan="5" align="right" >
                    <p style="font-weight: 700;font-size: 12px">  <?php if(!empty($requestValue['start_date']) && !empty($requestValue['end_date'])): ?> <?php echo e(date('dMy',strtotime($requestValue['start_date']))); ?> - <?php echo e(date('dMy',strtotime($requestValue['end_date']))); ?> <?php endif; ?> </p>
        ...
        <tr>
            <td colspan="5" align="right" valign="middle">
                <p style="text-decoration-line: none;font-size: 15px;font-weight: 700;padding: 0;margin: 0;margin-top: -5px">
                    Total MYR <?php echo e(number_format($grandTotal/100,2)); ?>
    ...
    <table border="0" cellpadding="0" cellspacing="0" class="table"
        ...
        <tr>
            <td colspan="5" align="right" valign="middle">
                <p style="text-decoration-line: none;font-size: 15px;font-weight: 700;padding: 0;margin: 0;margin-top: -5px">
                    Total MYR <?php echo e(number_format($grandTotal,2)); ?>
...
<?php /**PATH D:\Server_Files\oceania\trunk\oceania\resources\views/sales_report/sales_report_pdf.blade.php ENDPATH**/ ?>