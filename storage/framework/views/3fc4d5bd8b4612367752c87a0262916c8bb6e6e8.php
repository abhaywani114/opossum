...
function escpos_print_template() {
	...
	'\x0A',
    '\x1B' + '\x21' + '\x08',	// emphasized mode on
    'Personal Shift    '+ '<?php echo e($login_time); ?> <?php echo e($logout_time); ?>'+ '\x0A',
	'---------------------------------------------' + '\x0A',
...
//	'123456789012345678901234567890123456789012345'
	'\x1B' + '\x21' + '\x00',	// emphasized mode off
	'Branch Sales                       '+ '<?php echo e(str_pad($sales, 10, " ", STR_PAD_LEFT)); ?>' + '\x0A',

    'Branch ' +'<?php echo e(!empty($terminal->taxtype)?strtoupper($terminal->taxtype):"SST"); ?> <?php echo e($terminal->tax_percent??"6"); ?><?php echo e(str_pad("%",20," ",STR_PAD_RIGHT)); ?><?php echo e(str_pad($tax, 13, " ", STR_PAD_LEFT)); ?>' + '\x0A',
...
//   '123456789012345678901234567890123456789012345'
	'\x1B' + '\x21' + '\x00',	// emphasized mode off
	'Today Sales                        '+ '<?php echo e(str_pad( $sales,10, " ", STR_PAD_LEFT)); ?>' + '\x0A',

    '<?php echo e(!empty($terminal->taxtype)?strtoupper($terminal->taxtype):"SST"); ?> <?php echo e($terminal->tax_percent??"6"); ?><?php echo e(str_pad("%",20," ",STR_PAD_RIGHT)); ?><?php echo e(str_pad($tax, 20, " ", STR_PAD_LEFT)); ?>' + '\x0A',
...
//    '123456789012345678901234567890123456789012345'
	...
	'Cash                               '+ '<?php echo e(str_pad($cash, 10, " ", STR_PAD_LEFT)); ?>' + '\x0A',

    'Credit Card                        ' +'<?php echo e(str_pad($creditcard, 10, " ", STR_PAD_LEFT)); ?>' + '\x0A',


	'Wallet                        ' +'<?php echo e(str_pad($wallet, 10, " ", STR_PAD_LEFT)); ?>' + '\x0A',


    'Outdoor Payment Terminal ' +'<?php echo e(str_pad($creditcard, 20, " ", STR_PAD_LEFT)); ?>' + '\x0A',
...
<?php /**PATH D:\Server_Files\oceania\trunk\oceania\resources\views/printing/pshift_print.blade.php ENDPATH**/ ?>