	...
	<div id="void-div<?php echo e($receipt->id??''); ?>"
		...
		<div class="row">
			<div class="col-md-6 text-left"  style="color:red;">
				<b> <?php echo e($receipt->user->fullname??''); ?></b>
			</div>
		</div>
		<div class="row">
			<div class="col-md-6 text-left"  style="color:red;">
				<b><?php echo e($receipt->user->systemid??''); ?></b>
			</div>
		</div>
		<div class="row">
			<div class="col-md-6 text-left"  style="color:red;">
				<b id="void-time<?php echo e($receipt->id??''); ?>">
				<?php echo e($receipt->voided_at??''); ?>
...
<?php /**PATH D:\Server_Files\oceania\trunk\oceania\resources\views/cstore/receipt.blade.php ENDPATH**/ ?>