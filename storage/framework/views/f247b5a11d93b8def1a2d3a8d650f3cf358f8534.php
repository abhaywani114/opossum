...
<div class="container-fluid">
	<div class="d-flex mt-0 p-0"
		...
		<div style="padding:0" class="align-self-center col-sm-10">
			<div class="row mt-2">
				<div class="col-1">
					<img src="<?php echo e(url('/images/product/' . $product->systemid . '/thumb/' .
...
<?php echo $__env->make('common.web', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Server_Files\oceania\trunk\oceania\resources\views/local_price/barcode.blade.php ENDPATH**/ ?>