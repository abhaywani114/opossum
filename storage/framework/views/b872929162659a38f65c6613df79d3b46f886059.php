...
<script>
	...
	var staffTable = $('#tablestaff').DataTable({
		...
		"serverSide": true,
		"autoWidth":  false,
		"ajax": "<?php echo e(route('user_management.datatable')); ?>",
		columns: [
...
<?php /**PATH D:\Server_Files\oceania\trunk\oceania\resources\views/oceania_svr/user/landing.blade.php ENDPATH**/ ?>