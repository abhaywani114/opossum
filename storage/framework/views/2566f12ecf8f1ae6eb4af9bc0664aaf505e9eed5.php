    ...
    <div class="container-fluid">
        ...
        <div class="row py-2"
            ...
            <div class="col col-auto align-self-center">
                <button class="btn btn-success poa-bluecrab-button sellerbutton" id="confirm_update" onclick="update_quantity()"
                        style="padding-left:10px;margin-right:0px;display:block;cursor: pointer;opacity: 0.65;">
                    <span>Confirm</span>
                </button>
            </div>
        </div>
        ...
        <div style="padding-left:0;padding-right:0;" class="col-sm-12">
            <table id="fuelMgt" class="table table-bordered">
                ...
                <tr>
                    ...
                    <th style="width:100px;!important" nowrap>
					Book&nbsp;Qty&nbsp;(&ell;)</th>
                    <th style="width:140px;text-align: center;" nowrap>
					Qty&nbsp;In&nbsp;(&ell;)</th>
                </tr>
                </thead>
                <tbody>
...
<?php echo $__env->make('common.web', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Server_Files\oceania\trunk\oceania\resources\views/fuel_stockmgmt/stockout.blade.php ENDPATH**/ ?>