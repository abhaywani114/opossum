...
<div class="row pt-2 pb-0 m-0 pl-0 pr-0" style="">
	<div class="col-md-10 pt-2 pb-0 m-0 pl-0 pr-0"
		...
		<div class="row m-0 pt-2 pb-0 pl-0 pr-0 col-md-12"
			...
			<div class="row" style="">
				<div class="col-md-12 pr-0 pl-0">
					<button class="btn btn-success btn-sq-lg screend-button
						bg-virtualcabinet"
						onclick="window.open('<?php echo e(route('fuel-receipt-list' , ['date'=>strtotime(now())] )); ?>','_blank')"
					...
					<button class="btn poa-finish-button-disabled
						finish-button-0" onclick="process_finish()"
			...
			<div class="col-md-2 pt-2 pb-0 m-0 mb-3 pl-0 pr-0"
				...
				<div class="text-center"
					...
					<img src="<?php echo e(asset('images/delivering_spinball.gif')); ?>"
		...
		<div class="row m-0 pt-2 pb-0 pl-0 pr-0 col-md-12"
			...
			<div class="row" style="margin-bottom:5px !important">
				<div style="padding-right:20px"
					...
					<div class="col-md-12 mt-auto w-100 mr-0 pr-1 pl-0"
						...
						<div class="row p-0 m-0 text-white">
							<div class="col-6 p-0 m-0" id="table-PRODUCT-<?php echo e($i); ?>">
							</div>
							
							<div class="col-2 text-center" id="table-PRICE-<?php echo e($i); ?>">
							</div>

							<div class="col-2 text-center" id="table-QTY-<?php echo e($i); ?>">
							</div>

							<div class="col-2 p-0 m-0 text-right" id="table-MYR-<?php echo e($i); ?>">
							</div>
						</div>
				...
				<!--
				<div class="justify-content-center mt-1 align-items-center
					pt-2 pr-2 col-md-8 payment-div-refund<?php echo e($i); ?>"
					style="display:flex; background-color:black;
					border-radius:10px;height:50px !important;
					display:none">
					<span id="payment-div-refund-amount-bl-message<?php echo e($i); ?>"
						class="text-center" style="font-weight:bold;
						color:white;font-size:25px">
					</span>
				</div>
				...
				<div class="justify-content-center mt-1 align-items-center
					ml-1 payment-div-refund<?php echo e($i); ?>"
					style="display:flex;padding-top:3px;
					width:104px !important; background-color:black;
					border-radius:10px; height: 50px !important;
					display:none;">

					<span id="payment-div-refund-amount<?php echo e($i); ?>"
						class="text-center float-right"
						style="color:white;font-weight:bold;
						font-size:30px;">
					</span>
			...
			<div class="row" style="">
				<div class="col-md-12 pr-0 pl-0">
					...
					<button  class="btn poa-finish-button-disabled
						finish-button-<?php echo e($i); ?>" onclick="process_finish()"
						style="margin-left:0px!important;width:145px !important;">
						Finish
					</button> 
				</div>
		...
		<div class="col-md-6 pt-2 pb-0 m-0 pr-0 pl-5"
			...
			<div id='pump-auth-warn-<?php echo e($i); ?>'
				class="text-center"
			...
			<div class="row mt-auto" style="">
				...
				<div style="margin-bottom:5px"
					class="col-md-8 ml-0 pr-0 pl-0">
					<div id="amount-myr-<?php echo e($i); ?>"
						class="pl-1 pr-1" style="
						padding-top:10px; padding-bottom:10px;
						background-color:#f0f0f0;width:385px;
						border-radius:10px;height: 85px !important">
			...
			<div class="row" style="">
				...
				<div style="margin-bottom:5px" class="col-md-8 pr-0 pl-0">
					<div id="volume-liter-<?php echo e($i); ?>"
						class="pl-1 pr-1"
						style="background-color:#f0f0f0;width:385px;
						padding-top:10px;padding-bottom:10px;
						border-radius:10px;height:85px !important">
			...
			<div class="row">
				<div class="ml-0 p-0"
					style="width:60px; height:60px;text-align:center;
						...
						font-size:40px;color:white;"
						id="pump-number">
					<b id="pump-number-main-<?php echo e($i); ?>"><?php echo e($i); ?></b>
				</div>
				<div class="mr-2 ml-2 mt-2"
					style="position:relative;left:15px;
						line-height:1.2; color:white;
						font-size:20px;text-align: center;">
					<b>Price</b><br><?php echo e($currency); ?>

				</div>
				<div class="col-md-6 pr-0 pl-4">
					<div id="price-meter-<?php echo e($i); ?>"
						class="pl-8 pr-1"
						style="
						padding-top:10px; padding-bottom:10px;
						background-color:#f0f0f0;
			...
			<div style="min-height:100px;max-height:100px;display:flex"
				...
				<div class="row text-white"
					id="product-display-pump-<?php echo e($i); ?>"
					style="position:relative;top:0;left:0;
					align-items:center;">
					<img src='' id="fuel-grad-thumb-<?php echo e($i); ?>"
						style='width:70px;height:70px;display:inline-block;
						border-radius:10px;
						margin-right:12px;object-fit:contain;display:none'>
					<p class='m-0 p-0' id="fuel-grad-name-<?php echo e($i); ?>"
						style="text-align: center;font-size: 25px;
						font-weight: 600;"></p>
				</div>

				<!-- Display product buttons -->
				<div class="row text-white" id="product-select-pump-<?php echo e($i); ?>"
					...
					<?php if(!empty($nozzleFuelData->
						...
						<img  src='/images/product/<?php echo e($product->systemid); ?>/thumb/<?php echo e($product->thumbnail_1); ?>'
							id="fuel-grad-thumb-<?php echo e($i); ?>-option-<?php echo e($product->systemid); ?>"
							onclick="selectProduct('<?php echo e($i); ?>', '<?php echo e($product->id); ?>', '<?php echo e($product->name); ?>',
		...
		<div class="col-md-2 pt-2 pb-0 m-0 mb-3 pl-0 pr-0"
			...
			<!--div id="disp_ltr-<?php echo e($i); ?>"
				...
				<div class="text-center mb-2"
					style="color:white;font-size:2em; display: block;">
					<b id="total_volume-main-<?php echo e($i); ?>">0.00</b>
				</div>
			</div-->
			...
			<div class="text-center"
				style="margin-bottom:0 !important;color:white;
				font-size:20px">
				<b id="payment-status-<?php echo e($i); ?>"
			...
			<h1 class="text-center"
				id="preset-type-main-<?php echo e($i); ?>"
				style="margin-bottom:0 !important;color:white;
				font-size:20px">
				<?php echo e($currency); ?>
			...
			<div class="text-center mb-2"
				style="color:white;font-size:2em; display: block;">
				<b id="total_amount-main-<?php echo e($i); ?>">0.00</b>
			</div>
			<h1 class="mb-0 text-center"
				style="color:white;font-size:20px">Status
			</h1>
			<div class="text-center"
				style="color:white;font-size:20px">
				<b id="pump-status-main-<?php echo e($i); ?>">Online</b>
			</div>

			<div class="text-center"
				style="position:relative;top:10px;color:white;font-size:20px">
				<img id="pump-delivering-spinball-<?php echo e($i); ?>"
					src="<?php echo e(asset('images/delivering_spinball.gif')); ?>"
					style="width:80px;height:80px;object-fit:contain"/>
			</div>
		</div>
		</div>
	...
	<div class="row" style="margin-bottom:12px">
		...
		<div class="float-right mr-0 ">
			...
			<button class="btn poa-button-pump-idle mb-1"
				...
				id="pump-button-<?php echo e($i); ?>" onclick="pump_selected(<?php echo e($i); ?>)" >
				<img src="<?php echo e(asset('images/dispenser_icon.png')); ?>"
				...
				<p style="font-size: 0.7em;"
					id="pump-status-<?php echo e($i); ?>">Offline
				</p>
			</button>
			<?php endfor; ?>
		</div>
...
<?php echo $__env->make('landing.web', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Server_Files\oceania\trunk\oceania\resources\views/landing/landing.blade.php ENDPATH**/ ?>