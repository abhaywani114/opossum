...
class CreateEvReceiptsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('ev_receipt', function (Blueprint $table) {
            $table->id();
            // Unique ID coming from a DB sequence, "evreceipt_seq"
            ...
            * This is stored as percent e.g. 6.5% */
            ...
            // Transacted type
            $table->enum('transacted',[
				'h2','ev','opt','pos','wallet'
			])->default('ev');
            /* Description */
            ...
            /* MYR */
            $table->integer('myr')->unsigned()->default(0);
            /* Item Amount */
            $table->integer('itemAmount')->unsigned()->default(0);
            /* Taxe */
            $table->float('tax')->default(0);
            /* Total */
            $table->integer('total')->unsigne()->default(0);
    ...
    {
        Schema::dropIfExists('ev_receipts');
    }
}
